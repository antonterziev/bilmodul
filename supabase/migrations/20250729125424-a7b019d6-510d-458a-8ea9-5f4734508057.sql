-- Step 1: Create new enum with all existing permissions found in the data
CREATE TYPE public.app_permission AS ENUM ('admin', 'lager', 'ekonomi', 'inkop', 'pakostnad', 'forsaljning');
