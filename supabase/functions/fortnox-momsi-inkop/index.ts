...
serve(async (req) => {
  ...
  try {
    ...
    console.log('🚀 NEW VERSION: fortnox-moms-inkop function started')
    ...
    console.log(`🚀 Starting MOMS project creation for inventory item: ${inventoryItemId}, syncing user: ${syncingUserId}`)
    ...
    try {
      ...
      // 🧾 Step: Create supplier invoice with proper MOMS accounting
      console.log('📋 Creating supplier invoice with MOMS accounting...');
      try {
