                ...
                {showLagerExpanded && (
                  <div className="ml-0 mt-2 space-y-1">
                    <Button
                      variant="ghost"
                      size="sm"
                      className={`w-full justify-start text-sm pl-9 ${lagerFilter === 'på_lager' ? 'bg-primary text-primary-foreground' : 'text-muted-foreground'}`}
                      onClick={() => {
                        setShowPurchaseForm(false);
                        setShowLogistics(false);
                        setShowSales(false);
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className={`w-full justify-start text-sm pl-9 ${lagerFilter === 'såld' ? 'bg-primary text-primary-foreground' : 'text-muted-foreground'}`}
                      onClick={() => {
                        setShowPurchaseForm(false);
                        setShowLogistics(false);
                        setShowSales(false);
