              ...
              {accountCategories.map((category) => (
                ...
                >
                  <CollapsibleTrigger className="w-full">
                    <div className="flex items-center justify-between w-full p-3 bg-blue-50 rounded-lg transition-colors">
                              ...
                              <TableCell>{account.name}</TableCell>
                               <TableCell className="h-12">
                                 <Input
                                   ...
                                   disabled
                                   className="h-8 bg-muted text-muted-foreground cursor-default text-left truncate pl-3"
                                   readOnly
                                   placeholder={
